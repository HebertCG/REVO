...
async def run_test():
    ...
    try:
        ...
        # -> Abrir el formulario de inicio de sesión haciendo click en 'Iniciar Sesión'.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/nav/div/div/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Rellenar el email y la contraseña con credenciales válidas y enviar el formulario (1 intento).
        frame = context.pages[-1]
        # Input text
